...
function Footer() {
    return (
        <footer className="footer">
            <span style={{ display: 'flex', alignItems: 'center', gap: '1rem'}}><AccessTime/>Horário de trabalho:<br/>seg-sex 8:00 - 19:00<br/>sáb 9:00 - 17:00</span>
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: '1rem'}}><Email/>marcon@gmail.com</span>
        </footer>
    )
}
